...
I am grateful to my collaborators on the prior cross-city benchmark study~\cite{naeinian-cross-city-2026}. \textbf{Fatemeh Naeinian} took responsibility for the bulk of the figure generation and for a substantial share of the experimental infrastructure; \textbf{Haoran Zhu} contributed experimental implementation and analysis. Their work is visible throughout Chapter~\ref{chap:experiments}, most directly in the cross-city figures reproduced there.
...
The experimental program in this thesis ran on the \textbf{NYU Torch High Performance Computing cluster}. Approximately thirty-five thousand GPU-hours were consumed across the cross-city, generative-planning, and mechanistic-analysis studies on a mix of L40S and H200 nodes, and most of the mechanistic-analysis mechanistic analyses benefited directly from H200 throughput. I thank the NYU HPC staff for keeping those resources available and stable.

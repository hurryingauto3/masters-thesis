...
\caption[Per-run mechanistic artifacts index.]{Per-run mechanistic artifact index for the checkpoints analysed in~\refsec{sec:exp-why-ssl}. Columns identify the run, backbone, planner, training city, and cached-feature readouts. Rows are grouped by study family to match the main-text analysis.}\label{tab:mechanistic-index} \\
\toprule

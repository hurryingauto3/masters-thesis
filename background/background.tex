...
\begin{table}[ht]
\centering
\caption{Published TransFuser and Latent TransFuser baselines on \texttt{navtest}~\cite{dauner-navsim-2024}. Single-run standard deviation across training seeds is $\pm 0.56$ PDMS; the $0.2$-PDMS TF--LTF gap is within this band.}

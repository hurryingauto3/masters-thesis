...
Compact summary of the canonical Boston-trained Latent TransFuser rows from the v1.1 appendix roster table in~\reftab{tab:navsim_pdms_merged_v11_latf}. Each model is trained on Boston only and evaluated on every NAVSIM city. LV/B/P/S are destination-city PDMS percentages; \emph{OOD mean} averages the held-out cities and \emph{Drop} is the in-distribution-minus-OOD-mean gap in percentage points.}

...
{\bfseries
 ...
 {\large {\bf THESIS}}\\
  ...
  {\large MASTER OF SCIENCE (Electrical Engineering)}\\
  \vspace{.5in}
...
\underline{Major}: Electrical Engineering
\vspace{0.7in}

\noindent
\makebox[\textwidth]{\hfill\makebox[3in]{\hrulefill}}\\
\makebox[\textwidth]{\hfill\makebox[3in]{\hfill \textbf{Anna Choromanska}\hfill}}
\makebox[\textwidth]{\hfill\makebox[3in]{\hfill Professor of \hfill}}
\makebox[\textwidth]{\hfill\makebox[3in]{\hfill Electrical and Computer Engineering \hfill}}
...
\vspace{.25in}  
  ...
  {\bf the Degree of Master of Science (Electrical Engineering) }\\
  \vspace{.25in}
  {\bf \graddate}  
  \vspace{.25in}
}
...
\bibliography{thesis,introduction/introduction,background/background,relatedwork/relatedwork,methodology/methodology,experiments/experiments,conclusions/conclusions}

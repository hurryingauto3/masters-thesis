...
\newcommand{\thesistitle}{Self-Supervised Visual Representations for Cross-City Generalization in End-to-End Autonomous Driving}
...
% PLACEHOLDER dedication --- please edit before submission.
\newcommand{\thesisdedication}{To my family.}
...
%% Left margin = 1" (default) + \oddsidemargin = 1.5" (binding edge)
%% Right margin = 8.5" - 1.5" - 6.0" = 1.0"
...
%% Use a slightly tighter custom line spacing for readability.
%% Adjust this value if you want to move closer to single- or 1.5-spacing.
\setstretch{1.2} % requires package setspace, invoked above
...
Approved: \vspace{0.1in}

\hrule\vspace{4pt}
\centerline{\small Department Chair Signature}
\vspace{0.2in}
...
\vspace{0.3in}
\noindent
\underline{University ID}: \underline{N\#} % TODO: Add your University ID

\noindent
\underline{Net ID}: \hspace{.415in} \underline{ah7072}

\newpage

%%%%%%%%%%%%%% Copyright Page (optional — typically not recommended) %%%%%%%%%%%%%%%%%
...
\underline{Major}: Computer Engineering
\vspace{0.7in}

\hfill\parbox{3in}{%
\hrule\vspace{2pt}
\centerline{\textbf{Anna Choromanska}}
\centerline{Professor of}
\centerline{Electrical and Computer Engineering}
\vspace{0.3in}
\hrule\vspace{2pt}
\centerline{Date}
}
